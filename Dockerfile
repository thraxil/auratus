...
RUN mkdir -p /var/www/auratus
COPY requirements.txt /var/www/auratus/auratus/
RUN pip install -r /var/www/auratus/auratus/requirements.txt
WORKDIR /var/www/auratus/auratus
COPY . /var/www/auratus/auratus/
